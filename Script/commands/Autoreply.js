...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস হিমেল রে হাঙ্গা করো😶👻😘",
    "kiss de": "কিস দিস না তোর মুখে দূর গন্ধ কয়দিন ধরে দাঁত ব্রাশ করিস নাই🤬",
    "👍": "সর এখান থেকে লাইকার আবাল..!🐸🤣👍⛏️",
    "help": "Prefix de sala",
    "hi": "এত হাই-হ্যালো করো কেন প্রিও..!😜🫵",
    "bc": "SAME TO YOU😊",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Himel☜\nFacebook: https://www.facebook.com/profile.php?id=100083400862567\nWhatsApp: +8801820162372",
    "admin": "He is Himel তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "fork": "https://github.com/himel/HIMEL-CHAT-BOT.git",
    "kiss me": "তুমি পঁচা তোমাকে কিস দিবো না 🤭",
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস হিমেল রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস হিমেল এর ইনবক্সে এখুনি গুঁতা দেন🫢😻",
    "by": "কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি..!🌚🌶️",
    "ami himel": "হ্যাঁ বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐇𝐢𝐦𝐞𝐥 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss হিমেল এর ইনবক্সে গুতা দেন 😘",
